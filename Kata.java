...
public class Kata{
	...
	public static void main(String[] args){
		...
		System.out.println(Kata.trueEvenFalseOdd(number));
		System.out.println(Kata.isPrime(number));
		System.out.println(Kata.factorOf(number));
		System.out.println(Kata.isSquare(number));
		System.out.println(Kata.isPalindrome(number));
		System.out.println(Kata.factorialOf(number));
		System.out.println(Kata.squareOf(number));

		System.out.print("Enter integer to find positive difference: ");
		number = input.nextInt();
		int numberTwo = input.nextInt();
		System.out.println(Kata.posDifference(number, numberTwo));
		System.out.println(Kata.quotient(number, numberTwo));
